const permissionMatrix = [
  ...
  { module: "guest_groups", actions: ["view"] },
  { module: "meal_plans", actions: ["view"] },
  { module: "periods", actions: ["view"] },
  { module: "supplements", actions: ["view"] },
  { module: "refund_policies", actions: ["view"] },
  { module: "channel_manager_rooms", actions: ["view"] },
  { module: "rates", actions: ["view"] },
  { module: "availability", actions: ["view"] },
  ...
  if (userRole === "super_admin" || userRole === "superadminuser") {
    return [
      ...
      },
      {
        ...
        required_permission: "channel_manager:view",
      },
      {
        name: "Settings",
        icon: "settings",
