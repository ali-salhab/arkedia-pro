...
const COPY = {
  en: {
    ...
    add: "Add",
    hint: "Add up to 10 photos showcasing your restaurant, ambiance, dishes, and seating.",
  ...
  ar: {
    ...
    add: "إضافة",
    hint: "أضف حتى 10 صور توضح المطعم والأجواء والأطباق وأماكن الجلوس.",
    save: "حفظ وعرض التفاصيل",
    saving: "جارٍ الحفظ...",
    errorMain: "يرجى رفع صورة رئيسية قبل الحفظ",
    errorSave: "فشل الحفظ. يرجى المحاولة مجدداً.",
  },
};

const STORAGE_KEY = "restaurant_details_photos";

export default function RestaurantPhotosStep() {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      navigate("/restaurant/details/view");
    } catch {
