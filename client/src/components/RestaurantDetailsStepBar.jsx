...
export default function RestaurantDetailsStepBar() {
  ...
  const steps = [
    {
      label: t("restStepMain") || "Main Details",
      path: "/restaurant/details/main",
      Icon: FileSearch,
    },
    {
      label: t("restStepDescription") || "Description",
      path: "/restaurant/details/description",
      Icon: AlignLeft,
    },
    {
      label: t("restStepPolicy") || "Policy",
      path: "/restaurant/details/policy",
      Icon: ShieldCheck,
    },
    {
      label: t("restStepPhotos") || "Photos",
