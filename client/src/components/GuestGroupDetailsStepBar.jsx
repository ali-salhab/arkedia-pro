...
const STEP_STORAGE_KEYS = [
  "guest_group_main",
  "guest_group_nationalities",
];

export default function GuestGroupDetailsStepBar() {
  ...
  const steps = [
    {
      label: t("guestGroupStepMain") || "Main Details",
      path: "/hotel/channel-manager/travky/guest-group/main",
      Icon: FileSearch,
    },
    {
      label: t("guestGroupStepNationalities") || "Nationalities",
      path: "/hotel/channel-manager/travky/guest-group/nationalities",
      Icon: Users,
    },
    {
      label: t("guestGroupStepPreview") || "Preview",
