...
const rolePresets = {
  ...
  restaurant: ["users:view", "users:add", "users:edit", "users:delete", "restaurants:view", "restaurants:add", "restaurants:edit", "restaurants:delete", "rooms:view", "rooms:add", "rooms:edit", "rooms:delete", "bookings:view", "bookings:add", "bookings:edit", "finance:view", "reports:view", "settings:view", "restaurant:details"],
  restaurantuser: ["rooms:view", "bookings:view", "bookings:add", "bookings:edit"],
  activity: ["users:view", "users:add", "users:edit", "users:delete", "activities:view", "activities:add", "activities:edit", "activities:delete", "bookings:view", "bookings:add", "bookings:edit", "finance:view", "reports:view", "settings:view", "activity:details"],
